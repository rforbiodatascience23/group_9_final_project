...
ncbi_smoking_logfc_cord <- vroom::vroom("../data/04_ncbi_smoking_logfc_cord.tsv.gz",
                                 delim = "\t")
...
auged_norm_exprs_01 <- auged_norm_exprs_00 |>
  pivot_longer(cols = colnames(auged_norm_exprs_00[3:length(colnames(auged_norm_exprs_00))]),
               names_to = "gene",
