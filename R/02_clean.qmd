...
placenta_joined <- ncbi_clean_pheno |>
  full_join(transposed_placenta_expr)

maternal_joined <- ncbi_clean_pheno |>
  full_join(transposed_maternal_expr)

cord_joined <- ncbi_clean_pheno |>
  full_join(transposed_cord_expr)
...
write_tsv(x = ncbi_joined,
          file = "../data/02_ncbi_joined.tsv.gz")

write_tsv(x = placenta_joined,
          file = "../data/02_placenta_joined.tsv.gz")

write_tsv(x = maternal_joined,
          file = "../data/02_maternal_joined.tsv.gz")

write_tsv(x = cord_joined,
          file = "../data/02_cord_joined.tsv.gz")
