...
clean_pheno_data <- pheno_data |>
  ...
  select(gene_id, "Mother_age_years", apgar_score,"cord_blood_cotinine_ng_ml","gestational_age_weeks","maternal_blood_cotinine_ng_ml",maternal_bmi,smoking_status,newborn_weight_g,sex)
```
