...
ncbi_clean_expr <- gene_annotation |> 
  select(Symbol, 
         Probe_Id) |> 
...
# gene_expr_placenta
gene_expr_placenta <- get_gene_expr_by_source(ncbi_clean_expr, 
                                              sample_source_table, 
                                              "PL")

# gene_expr_maternal_blood
gene_expr_maternal_blood <- get_gene_expr_by_source(ncbi_clean_expr, 
                                                    sample_source_table, 
                                                    "M")

# gene_expr cord blood
gene_expr_cord_blood <- get_gene_expr_by_source(ncbi_clean_expr, 
                                                sample_source_table, 
                                                "D")
```
...
write_tsv(x = as_tibble(ncbi_clean_expr),
          file = "../data/02_ncbi_clean_expr.tsv.gz")
