...
ncbi_clean_expression <- read_tsv("../data/02_ncbi_clean_expression.tsv.gz")
```

```{r}
# fixing the column names
colnames(ncbi_clean_expression) <- ncbi_clean_expression[1,]
ncbi_clean_expression <- ncbi_clean_expression[-1,]
...
write_tsv(x = transposed_expr_data,
          file = "../data/04_ncbi_augment_expr.tsv.gz")
```
