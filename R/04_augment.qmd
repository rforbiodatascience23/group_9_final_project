...
# load tsv files
ncbi_joined <- vroom::vroom("../data/02_ncbi_joined.tsv.gz", 
                            delim = "\t")
placenta_joined <- vroom::vroom("../data/02_placenta_joined.tsv.gz", 
                            delim = "\t")
maternal_joined <- vroom::vroom("../data/02_maternal_joined.tsv.gz", 
                            delim = "\t")
cord_joined <- vroom::vroom("../data/02_cord_joined.tsv.gz", 
                            delim = "\t")
```
...
write_tsv(x = smoking_fc_cord,
          file = "../data/04_ncbi_smoking_logfc_cord.tsv.gz")
```
