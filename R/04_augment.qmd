...
transposed_expr_data <- ncbi_clean_expr |> 
  distinct(Gene,
           .keep_all = TRUE) |>
...
# fixing the column names (unnessecary)
#colnames(ncbi_clean_expr) <- ncbi_clean_expression[1,]
...
smoking_fold_change_cord_blood <-
...
write_tsv(x = smoking_fold_change_cord_blood,
