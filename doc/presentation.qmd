...
knitr::include_graphics("../results/plots/description_placentaWeight_boxplot.png", error = FALSE)
```
:::

::: {.column width="50%"}
```{r echo=FALSE, out.width="100%", fig.align='right'}
knitr::include_graphics("../results/plots/description_newbornWeight_boxplot", error = FALSE)
```

```{r echo=FALSE, out.width="100%", fig.align='left'}
knitr::include_graphics("../results/plots/description_CordCotinine_boxplot.png", error = FALSE)
```
:::
:::
...
```{r echo=FALSE, out.width="100%", fig.align='right'}
knitr::include_graphics("../results/plots/volcano_plot.png", error = FALSE)
```

## PCA plot

```{r echo=FALSE, out.width="100%", fig.align='right'}
knitr::include_graphics("../results/plots/PCA.png", error = FALSE)
```
