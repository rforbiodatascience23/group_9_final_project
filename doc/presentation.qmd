...
::: {.column width="100%"}
```{r echo=FALSE, out.width="40%", fig.align='center', out.height="40%"}
options(bitmapType='cairo', reproducible=TRUE, X11.options=list(type='cairo'))

knitr::include_graphics("../results/Plots/logfc_of_30_genes_affected_by_smoking.png", error = FALSE)
```
:::
:::
...
knitr::include_graphics("../results/plots/volcanoplots.png", error = FALSE)
```
